...
int t_fread_last_line()
{
    ...
    if (fread_last_line(test_file, result_line) && result_line == "First line of output") {
        ...
        std::cerr << "  Test 2 FAILED: Expected 'First line of output', got '" 
                  << result_line << "'\n";
    }
    ...
    if (!fread_last_line(test_file, result_line) && result_line.empty()) {
        ...
        std::cerr << "  Test 3 FAILED: Second read with no new content should return false, "
                  << "got return=" << fread_last_line(test_file, result_line) 
                  << " logline='" << result_line << "'\n";
    }
    ...
    if (fread_last_line(test_file, result_line) && result_line == "Second line of output") {
        ...
        std::cerr << "  Test 4 FAILED: Expected 'Second line of output', got '" 
                  << result_line << "'\n";
    }
    ...
    if (fread_last_line(test_file, result_line) && result_line == "Third line of output") {
        ...
        std::cerr << "  Test 5 FAILED: Expected 'Third line of output', got '" 
                  << result_line << "'\n";
    }
    ...
    if (fread_last_line(test_file, result_line) && result_line == "Line 6") {
        ...
        std::cerr << "  Test 6 FAILED: Expected 'Line 6', got '" 
                  << result_line << "'\n";
    }
    ...
    if (fread_last_line(test_file, result_line) && result_line == "Line 7") {
        ...
        std::cerr << "  Test 7 FAILED: Expected 'Line 7', got '" 
                  << result_line << "'\n";
    }
    ...
    if (fread_last_line(test_file, result_line) && result_line == "Line after blank") {
        ...
        std::cerr << "  Test 8 FAILED: Expected 'Line after blank', got '" 
                  << result_line << "'\n";
    }
    ...
    if (fread_last_line(test_file, result_line) && result_line == "New short line") {
        ...
        std::cerr << "  Test 10 FAILED: Expected 'New short line', got '" 
                  << result_line << "'\n";
    }
    ...
    if (fread_last_line(test_file, result_line) && result_line == "After truncation") {
        ...
        std::cerr << "  Test 13 FAILED: Should recover from truncation and return new content, got '"
                  << result_line << "'\n";
    }
