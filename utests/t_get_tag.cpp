...
int t_get_tag()
{
    ...
    test_count++;
    {
        ...
        if (test_result == "some_path/jf_file_xyz") {
            ...
            std::cerr << "  Test 2 FAILED: Expected 'some_path/jf_file_xyz', got '" 
                      << test_result << "'\n";
        }
        fs::remove(filename);
    }
    ...
    test_count++;
    {
        ...
        if (test_result.empty()) {
            ...
            std::cerr << "  Test 3 FAILED: ZIP file should return empty string, got '" 
                      << test_result << "'\n";
        }
        fs::remove(filename);
    }
    ...
    test_count++;
    {
        ...
        if (test_result.empty()) {
            ...
            std::cerr << "  Test 4 FAILED: Empty file should return empty string, got '" 
                      << test_result << "'\n";
        }
        fs::remove(filename);
    }
    ...
    test_count++;
    {
        ...
        if (test_result.empty()) {
            ...
            std::cerr << "  Test 5 FAILED: Plain text without delimiters should return empty, got '" 
                      << test_result << "'\n";
        }
        fs::remove(filename);
    }
    ...
    test_count++;
    {
        ...
        if (test_result == "../projects/jf_data") {
            ...
            std::cerr << "  Test 6 FAILED: Expected '../projects/jf_data', got '" 
                      << test_result << "'\n";
        }
        fs::remove(filename);
    }
    ...
    test_count++;
    {
        ...
        if (test_result.empty()) {
            ...
            std::cerr << "  Test 7 FAILED: Malformed reference should return empty, got '" 
                      << test_result << "'\n";
        }
        fs::remove(filename);
    }
    ...
    test_count++;
    {
        ...
        if (test_result.empty()) {
            ...
            std::cerr << "  Test 9 FAILED: Non-existent file should return empty, got '" 
                      << test_result << "'\n";
        }
    }
    ...
    test_count++;
    {
        ...
        if (test_result == "first_ref") {
            ...
            std::cerr << "  Test 10 FAILED: Expected 'first_ref', got '" 
                      << test_result << "'\n";
        }
        fs::remove(filename);
    }
